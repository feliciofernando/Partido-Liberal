      ...
      <header className="bg-gradient-to-r from-slate-800 to-slate-900 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold">Todos os Candidatos</h1>
          </div>
          <p className="text-white/80 text-lg max-w-2xl">
            Conheça todos os líderes e candidatos do Partido Liberal que estão trabalhando por um Angola melhor.
          </p>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {loading ? (
          <div className="flex items-center justify-center py-20">
            <Loader2 className="h-10 w-10 animate-spin text-party-blue" />
          </div>
        ) : leaders.length === 0 ? (
          <Card className="text-center py-20">
            <CardContent>
              <Users className="h-16 w-16 text-slate-300 mx-auto mb-4" />
              <h2 className="text-xl font-semibold text-slate-700 mb-2">Nenhum líder encontrado</h2>
              <p className="text-slate-500">Volte em breve para conhecer nossos líderes.</p>
            </CardContent>
          </Card>
        ) : (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {leaders.map((leader) => (
              <div
                key={leader.id}
                className="bg-card rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 group cursor-pointer"
