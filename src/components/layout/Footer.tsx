    ...
    <footer className="bg-slate-900 text-white mt-auto">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-3 mb-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm text-slate-400 leading-tight">Construindo o Futuro de Angola</span>
              </div>
            </Link>
          ...
          {/* Links */}
          <div>
            <h3 className="font-semibold text-sm uppercase tracking-wider mb-4 text-slate-300">O Partido</h3>
          ...
          <div>
            <h3 className="font-semibold text-sm uppercase tracking-wider mb-4 text-slate-300">Participe</h3>
            <ul className="space-y-3">
          ...
          <div>
            <h3 className="font-semibold text-sm uppercase tracking-wider mb-4 text-slate-300">Recursos</h3>
            <ul className="space-y-3">
