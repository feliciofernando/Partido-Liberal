...
<ul>
<li>Redução de 50% na mortalidade materna</li>
<li>Redução de 40% na mortalidade infantil</li>
<li>Atendimento pré-natal universal</li>
<li>Formação de 5.000 profissionais de saúde</li>
</ul>`,
    category: 'social',
...
<ul>
<li>Reforma curricular com foco em tecnologia</li>
<li>Formação contínua de professores</li>
<li>Um computador por aluno no ensino secundário</li>
<li>Bolsas de estudo para alunos meritórios</li>
</ul>`,
    category: 'politica',
...
<ul>
<li>Microcrédito para jovens empreendedores</li>
<li>Centros de formação profissional em todas as províncias</li>
<li>Estágios remunerados em empresas parceiras</li>
<li>Incubadoras de startups</li>
</ul>`,
    category: 'economia',
...
<h3>Eixos do Plano</h3>
<ul>
<li>5.000 km de estradas novas e reabilitadas</li>
<li>Electrificação rural em 500 comunidades</li>
<li>Água potável para 1 milhão de famílias</li>
<li>Construção de 100 pontes</li>
</ul>`,
    category: 'economia',
...
<h3>Propostas para Benguela</h3>
<ul>
<li>Modernização do Porto de Lobito</li>
<li>Apicultura e agricultura familiar</li>
<li>Centro de formação profissional</li>
<li>Hospital provincial reformado</li>
</ul>`,
    category: 'social',
...
<h3>Áreas Representadas</h3>
<ul>
<li>Economia e Finanças</li>
<li>Saúde Pública</li>
<li>Educação e Ciência</li>
<li>Infraestrutura e Habitação</li>
<li>Agricultura e Desenvolvimento Rural</li>
</ul>`,
    category: 'imprensa',
...
<ul>
<li>Microcrédito agrícola com juros reduzidos</li>
<li>Distribuição de sementes melhoradas</li>
<li>Formação em técnicas sustentáveis</li>
<li>Acesso a mercados e cooperativas</li>
</ul>`,
    category: 'economia',
...
async function insertNews() {
  console.log('Inserindo notícias no Supabase...\n');
  ...
  console.log('Limpando notícias existentes...');
  const deleteRes = await fetch(`${SUPABASE_URL}/rest/v1/News?id=neq.00000000-0000-0000-0000-000000000000`, {
    method: 'DELETE',
    headers: {
  ...
  if (deleteRes.ok) {
    console.log('✓ Notícias anteriores removidas\n');
  }
  ...
  for (let i = 0; i < newsData.length; i++) {
    ...
    console.log(`[${i + 1}/${newsData.length}] Inserindo: ${news.title.substring(0, 50)}...`);
  ...
  console.log('\n✅ Todas as notícias foram inseridas!');
}
